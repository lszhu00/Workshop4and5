  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.state.feedItem, 4, callbackFunction, this.state.index);
      } else {
        // User clicked 'like' button.
        likeComment(this.state.feedItem, 4, callbackFunction, this.state.index);
      }
    }
  }
      ...
      <div>
        ...
        <div className="media-body">
          ...
          <br /><a href="#" onClick={(e) => this.handleLikeClick(e)}>
            <span className="glyphicon glyphicon-thumbs-up"></span> {likeButtonText} ({this.state.likeCounter.length})
